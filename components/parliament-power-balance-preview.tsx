 ...
 */
export function ParliamentPowerBalancePreview() {
    ...
    <Card className="border-2">
      <CardHeader className="text-center pb-4">
        ...
        <CardDescription className="text-base max-w-2xl mx-auto">
          Visual representation of current parliamentary composition and political balance
        </CardDescription>
      </CardHeader>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="relative bg-muted/20 rounded-lg p-8 border">
              {/* Political Balance Indicators */}
              <div className="absolute top-4 right-4 text-right space-y-1 bg-background/95 p-3 rounded border shadow-sm z-10">
                <div className="text-xs uppercase tracking-wider text-muted-foreground font-medium">
                  Balance
                </div>
                <div className="text-sm">
                  <span className="font-bold text-primary">{totalSeats}</span> Total Seats
                </div>
                <div className="text-sm">
                  <span className="font-bold text-primary">{majorityThreshold}</span> Seats for Majority
                </div>
                {majorityParty && (
                  <div className="text-xs pt-1 border-t mt-2">
                    Majority held by{" "}
                    <span className="font-bold" style={{ color: majorityParty.color }}>
                      {majorityParty.name}
                    </span>
                  </div>
                )}
            ...
            <div className="mt-4 text-xs text-muted-foreground text-center">
              Hover or focus on seats for details • Hover on party legend to highlight blocks
            </div>
          </div>
